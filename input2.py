...
def conv_net(x, weights, biases, dropout):
    ...
    conv1 = conv2d(x, weights['wc1'], biases['bc1'])                 #1 480, 360

    # Convolution Layer 2 with no stride
    conv2 = conv2d(conv1, weights['wc2'], biases['bc2'])

    # Max Pooling (down-sampling)
    conv2 = maxpool2d(conv2, k=2)                                       #2  240, 180

    # Convolution Layer part 2
    conv3 = conv2d_s2(conv2, weights['wc3'], biases['bc3'])             #3  120, 90
    ...
    # Max Pooling (down-sampling)
    conv5 = maxpool2d(conv5, k=2)                                        #4  60, 45
